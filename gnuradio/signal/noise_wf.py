...
class noise_wf(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Connections
        ##################################################
        self.connect((self.analog_fastnoise_source_x_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.analog_fastnoise_source_x_0, 0), (self.qtgui_waterfall_sink_x_0, 0))
    ...
    def set_bandwidth(self, bandwidth):
        ...
        self.set_center_freq(self.bandwidth/2)
